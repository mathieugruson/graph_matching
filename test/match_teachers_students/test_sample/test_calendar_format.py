...
EXEMPLE = [
    ...
    'fields': {
                'Formateur': '',
                'Formateur Robot': '',
                'Formation': "SketchUp à destination d'un maquettiste",
                'Premiere partie': '2024-04-29T06:00:00.000Z',
                'Deuxieme partie': '2024-05-06T06:00:00.000Z',
...
{'id': 'rec0DQAls8iP58yT9',
 ...
 'fields': {'Title': 'Indisponible',
            ...
            'Creator': 'contact@example.fr',
            'Attendees' : ['contact@example.fr', 'contact@example.fr', 'quentin@example.fr']}
...
{'id': 'rec0DQAls8iP5MyT9',
 ...
 'fields': {'Title': 'Indisponible',
            ...
            'Creator': 'contact@example.fr',
            'Attendees' : ['contact@example.fr', 'contact@example.fr', 'adrien@example.fr']}
}
]
...
def test_calendar_format(current_week_num, CODE_TEST):
