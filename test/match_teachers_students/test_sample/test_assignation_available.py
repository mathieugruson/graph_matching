...
{'id': 'rec0DQAls8iP58yT9',
 ...
 'fields': {'Title': 'Indisponible',
            'Start': '2024-04-29T06:00:00.000Z',
            'End': '2024-04-29T08:00:00.000Z',
            'Creator': 'quentin@example.fr'}
}
]

output_expected = {'eleve1@gmail.com': {'Assigned Slots': {}, 'Teacher': None}}

def test_assignation_available(current_week_num, CODE_TEST):
