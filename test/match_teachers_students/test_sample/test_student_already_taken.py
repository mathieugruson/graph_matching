...
EXEMPLE = [
    ...
    'fields': {
                'Formateur': '',
                'Formateur Robot': 'quentin@example.fr',
...
{'id': 'rec0DQAls8iP58yT9',
 ...
 'fields': {'Title': 'Indisponible',
            ...
            'End': '2024-04-29T18:00:00.000Z',
            'Creator': 'quentin@example.fr'}
}
]

output_expected = {'eleve2@gmail.com': {'Assigned Slots': {}, 'Teacher': None}}

def test_student_already_taken(current_week_num, CODE_TEST):
